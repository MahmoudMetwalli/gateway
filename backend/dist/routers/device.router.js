...
import { CreatePeripheralDeviceSchema, UpdatePeripheralDeviceSchema, } from "../schemas/device.schema.js";
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.patch("/:id", validateRequest({ body: UpdatePeripheralDeviceSchema }), deviceController.updateDevice);
/**
 * @swagger
 * /api/devices/{id}:
 *   delete:
