...
import { CreateGatewaySchema, UpdateGatewaySchema, } from "../schemas/gateway.schema.js";
import { DeviceAttachSchema, GatewayLogSchema, } from "../schemas/miscellaneous.schema.js";
 ...
 */
router.post("/", validateRequest({ body: CreateGatewaySchema }), gatewayController.createGateway);
/**
 * @swagger
 * /api/gateways:
 *   get:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.patch("/:id", validateRequest({ body: UpdateGatewaySchema }), gatewayController.updateGateway);
/**
 * @swagger
 * /api/gateways/{id}:
 *   delete:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.post("/:id/devices", validateRequest({ body: DeviceAttachSchema }), gatewayController.attachDevice);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.get("/:id/logs", validateRequest({ params: GatewayLogSchema }), gatewayController.listGatewayLogs);
export default router;
//# sourceMappingURL=geteway.router.js.map