...
export async function serialNumberExists(serialNumber: string): Promise<boolean> {
...
export async function updateGateway(id: string, data: Prisma.GatewayUpdateInput) {
